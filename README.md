# LineageOS 13 for the Huawei P9 Lite (hi6250)
...
You'll need Linux to be able to build LineageOS 13. You have three choices here; you can:
...
In addition to Android's build prerequisites LineageOS 13 requires "maven"
```bash
...
<manifest>
  ...
  <project name="Meticulus/android_vendor_huawei_hi6250" path="vendor/huawei/hi6250" remote="github" revision="cm-13.0"/>
  <remove-project name="platform/packages/apps/Nfc"/>
  <project name="LineageOS/android_vendor_nxp-nfc_opensource_Nfc" path="vendor/nxp-nfc/opensource/Nfc" remote="github" revision="cm-13.0"/>
  <project name="LineageOS/android_vendor_nxp-nfc_opensource_libnfc-nci" path="vendor/nxp-nfc/opensource/libnfc-nci" remote="github" revision="cm-13.0"/>
  <project name="LineageOS/android_vendor_nxp-nfc_opensource_frameworks" path="vendor/nxp-nfc/opensource/frameworks" remote="github" revision="cm-13.0"/>
</manifest>
```
